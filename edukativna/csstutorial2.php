...
<h1>CSS Sintaksa</h1>
<img class="teorija" src="slike/csst1.gif">

<p>Selektor pokazuje na HTML element koji želite stilizirati.
<br>
Deklaracijski blok sadrži jednu ili više deklaracija odvojenih točkom i zarezom.
<br>
Svaka deklaracija uključuje naziv CSS svojstva i vrijednost, odvojene dvotočkom.
<br>
Višestruke CSS deklaracije odvojene su točkom i zarezom, a blokovi deklaracija okruženi su vitičastim zagradama.</p>

<div class="section_desno">
    <div class="editor_kontejner">
        <h1>CSS Primjer:</h1>
        <div class="editor9" id="htmlkod">
            <code>
            p {
                <br>
  color: red;
...
<h1>Objašnejnje primjera</h1>

<p>
p je selektor u CSS-u (pokazuje na HTML element koji želite stilizirati: &lt;p&gt;).
<br>
boja je svojstvo, a crvena je vrijednost svojstva
<br>

text-align je svojstvo, a center je vrijednost svojstva
<br>
...
function otvoriiducu() {
  window.location.href = 'csstutorial3.php';
}
function otvoriproslu() {
  window.location.href = 'csstutorial1.php';
}
